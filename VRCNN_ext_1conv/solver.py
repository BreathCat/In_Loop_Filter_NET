...
from VRCNN_ext_1conv.model import Net,VR_Block
...
class VRCNN_ext_1convTrainer(object):
    def __init__(self, config, training_loader, testing_loader):
        super(VRCNN_ext_1convTrainer, self).__init__()
    ...
    def build_model(self):
        self.model = Net(VR_Block).to(self.device)
    ...
    def train(self):
        ...
        print("    Average Loss: {:.6f}".format(train_loss / len(self.training_loader)),end='')
