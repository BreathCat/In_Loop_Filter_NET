...
low_input='./test_model/low_input/'
model_dir='./model_save'



for file in os.listdir(low_input):
    low_input_dir=os.path.join(low_input,file)#low_input_dir='./test_model/low_input/not_in_train_and_test'
                                              #low_input_dir=' ./test_model/low_input/in_train'
                                              #low_input_dir='./test_model/low_input/in_test'
