...
class Net(torch.nn.Module):
    def __init__(self, num_channels, upscale_factor, d=64, s=12, m=4):
        ...
        # Deconvolution
        self.last_part = nn.ConvTranspose2d(in_channels=d, out_channels=num_channels, kernel_size=9, stride=1, padding=4, output_padding=0)
...
model = Net(num_channels = 1, upscale_factor = 1).to(device)
